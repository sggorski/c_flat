...
public class MusicParser extends Parser {
	...
	public static final int
		...
		RULE_elseif = 25, RULE_else = 26, RULE_forInit = 27, RULE_forUpdate = 28, 
		RULE_forAssignment = 29, RULE_breakStatement = 30, RULE_continueStatement = 31, 
		RULE_functionCall = 32, RULE_arguments = 33, RULE_settingsList = 34, RULE_expr = 35, 
		RULE_orderOp = 36, RULE_eqOp = 37, RULE_andOp = 38, RULE_orOp = 39, RULE_addSubOp = 40, 
		RULE_mullDivOp = 41, RULE_assOp = 42, RULE_chord = 43, RULE_trackStatements = 44, 
		RULE_trackStatement = 45, RULE_trackDeclaration = 46, RULE_intVal = 47;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"controlStatement", "loop", "loopBody", "if", "elseif", "else", "forInit", 
