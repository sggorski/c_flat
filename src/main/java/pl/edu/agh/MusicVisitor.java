...
public interface MusicVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MusicParser#includes}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIncludes(MusicParser.IncludesContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MusicParser#print}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrint(MusicParser.PrintContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCastExpr(MusicParser.CastExprContext ctx);
	/**
